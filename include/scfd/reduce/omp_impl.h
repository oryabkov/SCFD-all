...
#ifndef __SCFD_REDUCE_OMP_IMPL_H__
#define __SCFD_REDUCE_OMP_IMPL_H__
...
template <class Ord>
template <class T>
T omp<Ord>::operator()( Ord size, const T *input, T init_val ) const
{
...
T omp<Ord>::operator()( Ord size, const T *input, T init_val, BinaryOp binary_op ) const
{
    T res = init_val;
#pragma omp parallel
    {
