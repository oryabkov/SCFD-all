...
#ifndef __SCFD_REDUCE_SYCL_IMPL_H__
#define __SCFD_REDUCE_SYCL_IMPL_H__
...
template <class Ord>
template <class T>
T sycl<Ord>::operator()( Ord size, const T *input, T init_val ) const
{
...
T sycl<Ord>::operator()( Ord size, const T *input, T init_val, BinaryOp binary_op ) const
{
