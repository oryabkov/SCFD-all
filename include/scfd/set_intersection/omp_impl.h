...
#ifndef __SCFD_SET_INTERSECTION_OMP_IMPL_H__
#define __SCFD_SET_INTERSECTION_OMP_IMPL_H__
...
template <class Ord>
template <class T>
Ord omp<Ord>::operator()( Ord size1, const T *set1, Ord size2, const T *set2, T *result ) const
{
    if ( size1 <= 0 || size2 <= 0 )
        return 0;
