...
#ifndef __SCFD_EXCLUSIVE_SCAN_SYCL_IMPL_H__
#define __SCFD_EXCLUSIVE_SCAN_SYCL_IMPL_H__
...
template <class Ord>
template <class T>
void sycl<Ord>::operator()( Ord size, const T *input, T *output, T init_val ) const
{
