...
struct parted_map
{
    ...
    //dummy constructor
    parted_map( const Partitioner &_part, bool _r_stencil_only = false )
        : part( _part ), r_stencil_only( _r_stencil_only )
    {
    }
    ...
    {
        return part.get_own_rank();
    }
    bool check_glob_owned( int i ) const
    {
        return part.check_glob_owned( i );
    }
    glob_ordinal_type get_total_size() const
    {
        return part.get_total_size();
    }
    loc_ordinal_type get_size() const
    {
        return part.get_size();
    }
    glob_ordinal_type own_glob_ind( loc_ordinal_type i ) const
    {
        return part.own_glob_ind( i );
    }
    ...
    {
        return part.get_rank( i );
    }
    bool check_glob_owned( int i, int rank ) const
    {
        return part.check_glob_owned( i, rank );
    }
