    ...
    struct packet_bucket
    {
        ...
        void sync_from_array( const ForEach &for_each, const Array &array ) const
        {
            if ( detail::get_array_tensor_dim( array ) > detail::get_array_tensor_dim( buf_array_device() ) )
                throw std::logic_error( "mpi_rect_distributor::packet_bucket::sync_from_array: array tensor dir "
        ...
        {
            if ( detail::get_array_tensor_dim( array ) > detail::get_array_tensor_dim( buf_array_device() ) )
                throw std::logic_error( "mpi_rect_distributor::packet_bucket::sync_to_array: array tensor dir exceeds "
