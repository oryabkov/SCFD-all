...
#ifndef __SCFD_COUNT_BY_KEY_OMP_IMPL_H__
#define __SCFD_COUNT_BY_KEY_OMP_IMPL_H__
...
Ord omp<Ord>::operator()( Ord size, const Key *keys_in, Key *keys_out, Count *counts_out, KeyEqual key_equal ) const
{
    if ( size <= 0 )
        return 0;
