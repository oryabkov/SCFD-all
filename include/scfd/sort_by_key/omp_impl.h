...
#ifndef __SCFD_SORT_BY_KEY_OMP_IMPL_H__
#define __SCFD_SORT_BY_KEY_OMP_IMPL_H__
...
void omp<Ord>::operator()( Ord size, Key *keys, Value *values, Compare compare ) const
{
#pragma omp parallel
    {
#pragma omp single
