...
#ifndef __SCFD_SORT_BY_KEY_SYCL_IMPL_H__
#define __SCFD_SORT_BY_KEY_SYCL_IMPL_H__
...
void sycl<Ord>::operator()( Ord size, Key *keys, Value *values, Compare compare ) const
{
    if ( size <= 0 )
        return;
