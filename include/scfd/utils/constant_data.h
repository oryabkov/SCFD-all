...
template <typename T>
struct utils_argument_type;
template <typename T, typename U>
struct utils_argument_type<T( U )>
{
    typedef U type;
};
...
#        define DEFINE_CONSTANT_BUFFER_ACCESS_FUNC( buf_type, buf_name )                                               \
            ...
            {                                                                                                          \
                return reinterpret_cast<utils_argument_type<void( buf_type )>::type &>(                                \
...
#        define DEFINE_CONSTANT_BUFFER_ACCESS_FUNC( buf_type, buf_name )                                               \
            ...
            {                                                                                                          \
                return reinterpret_cast<utils_argument_type<void( buf_type )>::type &>(                                \
                    __CONSTANT_BUFFER__CTASTR( __h_, buf_name )                                                        \
                );                                                                                                     \
            }
#    endif
