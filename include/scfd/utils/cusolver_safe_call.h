...
static const char *_cusolverGetErrorEnum( cusolverStatus_t error )
{
    ...
    case CUSOLVER_STATUS_NOT_INITIALIZED:
        return "The cusolver library was not initialized. This is usually caused by the lack of a prior "
               "cusolverCreate() call, an error in the CUDA Runtime API called by the cusolver routine, or an error in "
               "the hardware setup.";

    case CUSOLVER_STATUS_ALLOC_FAILED:
        return "Resource allocation failed inside the cusolver library. This is usually caused by a cudaMalloc() "
               "failure.";
    ...
    case CUSOLVER_STATUS_EXECUTION_FAILED:
        return "The GPU program failed to execute. This is often caused by a launch failure of the kernel on the GPU, "
    ...
    case CUSOLVER_STATUS_IRS_NOT_SUPPORTED:
        return "One of the configuration parameter in the gels_irs_params structure is not supported. For example if "
               "nrhs >1, and refinement solver was set to CUSOLVER_IRS_REFINE_GMRES";
