...
#ifndef __SCFD_UTILS_VALS_TABLE_H__
#define __SCFD_UTILS_VALS_TABLE_H__
...
struct vals_table_1d
{
    ...
    __DEVICE_TAG__ int get_vals_n() const
    {
        return vals_n;
    }
...
struct vals_table_2d
{
    ...
    __DEVICE_TAG__ int get_vals_n1() const
    {
        return vals_n1;
    }
    __DEVICE_TAG__ int get_vals_n2() const
    {
        return vals_n2;
    }
...
struct vals_table_3d
{
    ...
    __DEVICE_TAG__ int get_vals_n3() const
    {
        return vals_n3;
    }
...
struct vals_table_4d
{
    ...
    __DEVICE_TAG__ int get_vals_n4() const
    {
        return vals_n4;
    }
