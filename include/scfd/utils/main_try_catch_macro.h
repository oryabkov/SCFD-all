...
#    define SCFD_MAIN_CATCH( error_return_code )                                                                       \
        ...
        MAIN_TRY_CATCH_LOG_OBJ_POINTER->info_f(                                                                        \
            "wall host time for " + MAIN_TRY_CATCH_CURRENT_BLOCK_NAME + ": %f ms",                                     \
            MAIN_TRY_CATCH_CURRENT_FP_MS.count()                                                                       \
        );                                                                                                             \
        }                                                                                                              \
        catch ( std::exception & e )                                                                                   \
        {                                                                                                              \
            MAIN_TRY_CATCH_LOG_OBJ_POINTER->error(                                                                     \
                std::string( "error during " ) + MAIN_TRY_CATCH_CURRENT_BLOCK_NAME + std::string( ":\n" ) +            \
