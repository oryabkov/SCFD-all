...
#define FOR_EACH_FUNC_ARG_N(_11, _12, _21, _22, _31, _32, _41, _42, _51, _52, _61, _62, _71, _72, _81, _82, _91, _92, _101, _102, _111, _112, _121, _122, _131, _132, _141, _142, _151, _152, _161, _162, _171, _172, _181, _182, N, ...) N 
#define FOR_EACH_FUNC_RSEQ_N() 18, 18, 17, 17, 16, 16, 15, 15, 14, 14, 13, 13, 12, 12, 11, 11, 10, 10, 9, 9, 8, 8, 7, 7, 6, 6, 5, 5, 4, 4, 3, 3, 2, 2, 1, 1, 0, 0
...
#define FOR_EACH_FUNC_PARAMS_DEF_13(par_type, par_name, ...)                            \
  par_type par_name;                                                                    \
  FOR_EACH_FUNC_PARAMS_DEF_12(__VA_ARGS__)
#define FOR_EACH_FUNC_PARAMS_DEF_14(par_type, par_name, ...)                            \
  par_type par_name;                                                                    \
  FOR_EACH_FUNC_PARAMS_DEF_13(__VA_ARGS__)
#define FOR_EACH_FUNC_PARAMS_DEF_15(par_type, par_name, ...)                            \
  par_type par_name;                                                                    \
  FOR_EACH_FUNC_PARAMS_DEF_14(__VA_ARGS__)
#define FOR_EACH_FUNC_PARAMS_DEF_16(par_type, par_name, ...)                            \
  par_type par_name;                                                                    \
  FOR_EACH_FUNC_PARAMS_DEF_15(__VA_ARGS__)
#define FOR_EACH_FUNC_PARAMS_DEF_17(par_type, par_name, ...)                            \
  par_type par_name;                                                                    \
  FOR_EACH_FUNC_PARAMS_DEF_16(__VA_ARGS__)
#define FOR_EACH_FUNC_PARAMS_DEF_18(par_type, par_name, ...)                            \
  par_type par_name;                                                                    \
  FOR_EACH_FUNC_PARAMS_DEF_17(__VA_ARGS__)
...
#define FOR_EACH_FUNC_PARAMS_LIST_13(par_type, par_name, ...)                                                           \
  par_type FOR_EACH_FUNC_CONCATENATE(_,par_name),                                                                       \
  FOR_EACH_FUNC_PARAMS_LIST_12(__VA_ARGS__)
#define FOR_EACH_FUNC_PARAMS_LIST_14(par_type, par_name, ...)                                                           \
  par_type FOR_EACH_FUNC_CONCATENATE(_,par_name),                                                                       \
  FOR_EACH_FUNC_PARAMS_LIST_13(__VA_ARGS__)
#define FOR_EACH_FUNC_PARAMS_LIST_15(par_type, par_name, ...)                                                           \
  par_type FOR_EACH_FUNC_CONCATENATE(_,par_name),                                                                       \
  FOR_EACH_FUNC_PARAMS_LIST_14(__VA_ARGS__)
#define FOR_EACH_FUNC_PARAMS_LIST_16(par_type, par_name, ...)                                                           \
  par_type FOR_EACH_FUNC_CONCATENATE(_,par_name),                                                                       \
  FOR_EACH_FUNC_PARAMS_LIST_15(__VA_ARGS__)
#define FOR_EACH_FUNC_PARAMS_LIST_17(par_type, par_name, ...)                                                           \
  par_type FOR_EACH_FUNC_CONCATENATE(_,par_name),                                                                       \
  FOR_EACH_FUNC_PARAMS_LIST_16(__VA_ARGS__)
#define FOR_EACH_FUNC_PARAMS_LIST_18(par_type, par_name, ...)                                                           \
  par_type FOR_EACH_FUNC_CONCATENATE(_,par_name),                                                                       \
  FOR_EACH_FUNC_PARAMS_LIST_17(__VA_ARGS__)
...
#define FOR_EACH_FUNC_PARAMS_CC_13(par_type, par_name, ...)                                                             \
  par_name(FOR_EACH_FUNC_CONCATENATE(_,par_name)),                                                                      \
  FOR_EACH_FUNC_PARAMS_CC_12(__VA_ARGS__)
#define FOR_EACH_FUNC_PARAMS_CC_14(par_type, par_name, ...)                                                             \
  par_name(FOR_EACH_FUNC_CONCATENATE(_,par_name)),                                                                      \
  FOR_EACH_FUNC_PARAMS_CC_13(__VA_ARGS__)
#define FOR_EACH_FUNC_PARAMS_CC_15(par_type, par_name, ...)                                                             \
  par_name(FOR_EACH_FUNC_CONCATENATE(_,par_name)),                                                                      \
  FOR_EACH_FUNC_PARAMS_CC_14(__VA_ARGS__)
#define FOR_EACH_FUNC_PARAMS_CC_16(par_type, par_name, ...)                                                             \
  par_name(FOR_EACH_FUNC_CONCATENATE(_,par_name)),                                                                      \
  FOR_EACH_FUNC_PARAMS_CC_15(__VA_ARGS__)
#define FOR_EACH_FUNC_PARAMS_CC_17(par_type, par_name, ...)                                                             \
  par_name(FOR_EACH_FUNC_CONCATENATE(_,par_name)),                                                                      \
  FOR_EACH_FUNC_PARAMS_CC_16(__VA_ARGS__)
#define FOR_EACH_FUNC_PARAMS_CC_18(par_type, par_name, ...)                                                             \
  par_name(FOR_EACH_FUNC_CONCATENATE(_,par_name)),                                                                      \
  FOR_EACH_FUNC_PARAMS_CC_17(__VA_ARGS__)
