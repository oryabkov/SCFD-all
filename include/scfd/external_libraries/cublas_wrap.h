...
public:
    ...
    cublas_wrap( bool plot_info, bool do_set_inst )
    ...
    void sum_abs_elements(
        size_t vector_size, const T *vector, typename cublas_real_types::cublas_real_type_hlp<T>::type *result,
        int incx = 1
    );
    ...
    template <typename T>
    void asum(
        size_t vector_size, const T *x, typename cublas_real_types::cublas_real_type_hlp<T>::type *result, int incx = 1
    );
    //vector l2 norm.
    template <typename T>
    void norm2(
    ...
    template <typename T>
    void scale(
        size_t vector_size, const typename cublas_real_types::cublas_real_type_hlp<T>::type alpha, T *x, int incx = 1
    );
    ...
    template <typename T>
    void normalize(
        size_t vector_size, T *x, typename cublas_real_types::cublas_real_type_hlp<T>::type *norm, int incx = 1
    );
...
template <>
inline void cublas_wrap::sum_abs_elements(
    size_t vector_size, const cuComplex *vector,
...
template <>
inline void cublas_wrap::sum_abs_elements(
    size_t vector_size, const cuDoubleComplex *vector,
...
inline void cublas_wrap::asum(
    size_t vector_size, const cuComplex *x, typename cublas_real_types::cublas_real_type_hlp<cuComplex>::type *result,
    int incx
)
{
...
template <>
inline void cublas_wrap::asum(
    size_t vector_size, const cuDoubleComplex *x,
    typename cublas_real_types::cublas_real_type_hlp<cuDoubleComplex>::type *result, int incx
)
{
...
template <>
inline void cublas_wrap::normalize( size_t vector_size, float *x, float *norm, int incx )
{
...
template <>
inline void cublas_wrap::normalize( size_t vector_size, double *x, double *norm, int incx )
{
...
template <>
inline void cublas_wrap::normalize(
    size_t vector_size, cuComplex *x, typename cublas_real_types::cublas_real_type_hlp<cuComplex>::type *norm, int incx
)
{
...
template <>
inline void cublas_wrap::normalize(
    size_t vector_size, cuDoubleComplex *x,
    typename cublas_real_types::cublas_real_type_hlp<cuDoubleComplex>::type *norm, int incx
)
{
...
inline void cublas_wrap::normalize(
    ...
    typename cublas_real_types::cublas_real_type_hlp<thrust::complex<float>>::type *norm, int incx
)
{
...
inline void cublas_wrap::normalize(
    ...
    typename cublas_real_types::cublas_real_type_hlp<thrust::complex<double>>::type *norm, int incx
)
{
