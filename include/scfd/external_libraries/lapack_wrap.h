...
extern "C" void dhseqr_(
    char *JOB, char *COMPZ, int *N, int *ILO, int *IHI, double *H, int *LDH, double *WR, double *WI, double *Z,
    int *LDZ, double *WORK, int *LWORK, int *INFO
);

extern "C" void shseqr_(
    char *JOB, char *COMPZ, int *N, int *ILO, int *IHI, float *H, int *LDH, float *WR, float *WI, float *Z, int *LDZ,
    float *WORK, int *LWORK, int *INFO
);

extern "C" void dgeev_(
    char *jobvl, char *jobvr, int *n, double *a, int *lda, double *wR, double *wI, double *vl, int *ldvl, double *vr,
...
extern "C" void dormqr_(
    char *SIDE, char *TRANS, int *M, int *N, int *K, double *A, int *LDA, double *TAU, double *C, int *LDC,
...
extern "C" void dgemm_(
    char *TRANSA, char *TRANSB, int *M, int *N, int *K, double *ALPHA, double *A, int *LDA, double *B, int *LDB,
    double *BETA, double *C, int *LDC
);
extern "C" void sgemm_(
    char *TRANSA, char *TRANSB, int *M, int *N, int *K, float *ALPHA, float *A, int *LDA, float *B, int *LDB,
    float *BETA, float *C, int *LDC
);
extern "C" void zgemm_(
    char *TRANSA, char *TRANSB, int *M, int *N, int *K, std::complex<double> *ALPHA, std::complex<double> *A, int *LDA,
    std::complex<double> *B, int *LDB, std::complex<double> *BETA, std::complex<double> *C, int *LDC
);
extern "C" void cgemm_(
    char *TRANSA, char *TRANSB, int *M, int *N, int *K, std::complex<float> *ALPHA, std::complex<float> *A, int *LDA,
    std::complex<float> *B, int *LDB, std::complex<float> *BETA, std::complex<float> *C, int *LDC
);
extern "C" void
dtrexc_( char *COMPQ, int *N, double *T, int *LDT, double *Q, int *LDQ, int *IFST, int *ILST, double *WORK, int *INFO );
extern "C" void
strexc_( char *COMPQ, int *N, float *T, int *LDT, float *Q, int *LDQ, int *IFST, int *ILST, float *WORK, int *INFO );
extern "C" void dgees_(
    char *JOBVS, char *SORT, int *SELECT, int *N, double *A, int *LDA, int *SDIM, double *WR, double *WI, double *VS,
    int *LDVS, double *WORK, int *LWORK, int *BWORK, int *INFO
);
extern "C" void sgees_(
    char *JOBVS, char *SORT, int *SELECT, int *N, float *A, int *LDA, int *SDIM, float *WR, float *WI, float *VS,
    int *LDVS, float *WORK, int *LWORK, int *BWORK, int *INFO
);
...
extern "C" void dgels_(
    char *TRANS, int *M, int *N, int *NRHS, double *A, int *LDA, double *B, int *LDB, double *WORK, int *LWORK,
    int *INFO
);
...
public:
    lapack_wrap( size_t expected_size_ ) : expected_size( expected_size_ )
    {
        set_worker();
    ...
    //LDC = max( 1, m )
    void gemm(
        char opA, char opB, int rows_op_A, int cols_op_B, int cols_op_A_rows_op_B, const T alpha, const T *A,
        const T *B, const T beta, T *C
    );

    void gemm(
        char opA, char opB, int rows_op_A, int cols_op_B, int cols_op_A_rows_op_B, const std::complex<T> alpha,
        const std::complex<T> *A, const std::complex<T> *B, const std::complex<T> beta, std::complex<T> *C
    );
    ...
    void set_submatrix(
        std::pair<size_t, size_t> start, const T *subA, std::pair<size_t, size_t> subsize, T *A,
    ...
    // std::pair<size_t, size_t> (row, col)
    void return_submatrix(
        const T *A, std::pair<size_t, size_t> size, std::pair<size_t, size_t> start, T *subA,
        std::pair<size_t, size_t> subsize
    )
    {
        size_t row_start      = start.first;
        size_t col_start      = start.second;
        ...
        else
        {
            ...
            if ( D > 0.0 )
            {
                throw std::runtime_error(
                    "lapack_wrap::solve_2_2_eigensystem: real eigenvalue for a 2X2 Schur block, D = " +
                    std::to_string( D )
                );
            }
            T                            sqrtD = std::sqrt( -D );
...
template <>
inline void lapack_wrap<double>::reorder_schur( double *R, double *Q, size_t Nl, size_t ifst_row, size_t ilst_row )
{
    set_helper_matrices( Nl );
...
template <>
inline void lapack_wrap<float>::reorder_schur( float *R, float *Q, size_t Nl, size_t ifst_row, size_t ilst_row )
{
    set_helper_matrices( Nl );
    char COMPQ = 'V'; //update Q matrix
    int  N     = Nl;
...
template <>
inline void lapack_wrap<double>::hessinberg_eigs( const double *H, size_t Nl, double *eig_real, double *eig_imag )
{
    set_helper_matrices( Nl );
    copy_square_1_to_2( H, A_, Nl );
    char    JOB   = 'E';
    ...
    lapack_exters::dhseqr_(
        &JOB, &COMPZ, &N, &ILO, &IHI, A_, &LDH, eig_real, eig_imag, Z, &LDZ, worker, &LWORK, &INFO
    );
...
template <>
inline void lapack_wrap<float>::hessinberg_eigs( const float *H, size_t Nl, float *eig_real, float *eig_imag )
{
    set_helper_matrices( Nl );
    copy_square_1_to_2( H, A_, Nl );
    char   JOB   = 'E';
...
template <>
inline void lapack_wrap<double>::hessinberg_schur(
    const double *H, size_t Nl, double *Q, double *R, double *eig_real, double *eig_imag
)
{
    set_helper_matrices( Nl );
    copy_square_1_to_2( H, A_, Nl );
    ...
    lapack_exters::dhseqr_(
        &JOB, &COMPZ, &N, &ILO, &IHI, A_, &LDH, eig_real, eig_imag, Q, &LDZ, worker, &LWORK, &INFO
    );
...
template <>
inline void
lapack_wrap<float>::hessinberg_schur( const float *H, size_t Nl, float *Q, float *R, float *eig_real, float *eig_imag )
{
    set_helper_matrices( Nl );
    copy_square_1_to_2( H, A_, Nl );
    char JOB   = 'S';
...
template <>
inline void lapack_wrap<double>::eigs( const double *A, size_t Nl, double *eig_real, double *eig_imag )
{
...
template <>
inline void lapack_wrap<float>::eigs( const float *A, size_t Nl, float *eig_real, float *eig_imag )
{
...
template <>
inline void lapack_wrap<double>::eigsv( const double *A, size_t Nl, double *eig_real, double *eig_imag, double *eigv_R )
{
...
template <>
inline void lapack_wrap<float>::eigsv( const float *A, size_t Nl, float *eig_real, float *eig_imag, float *eigv_R )
{
...
template <>
inline void lapack_wrap<double>::qr_( double *A, double *Q, double *R )
{
    int N = expected_size;
    int M = N, LDA = N;
    int INFO  = 0;
    ...
    int  K = N, LDC = N;
    eye( Q );
    lapack_exters::dormqr_( &SIDE, &TRANS, &M, &N, &K, A, &LDA, B_, Q, &LDC, worker, &LWORK, &INFO );
    if ( INFO != 0 )
    {
...
template <>
inline void lapack_wrap<float>::qr_( float *A, float *Q, float *R )
{
    int N = expected_size;
    int M = N, LDA = N;
    int INFO  = 0;
    ...
    int  K = N, LDC = N;
    eye( Q );
    lapack_exters::sormqr_( &SIDE, &TRANS, &M, &N, &K, A, &LDA, B_, Q, &LDC, worker, &LWORK, &INFO );
    if ( INFO != 0 )
    {
...
template <>
inline void lapack_wrap<double>::qr_no_R_( double *A, double *Q )
{
    int N = expected_size;
    int M = N, LDA = N;
    int INFO  = 0;
...
template <>
inline void lapack_wrap<float>::qr_no_R_( float *A, float *Q )
{
    int N = expected_size;
    int M = N, LDA = N;
    int INFO  = 0;
...
//LDC = max( 1, m )
template <>
inline void lapack_wrap<double>::gemm(
    char opA, char opB, int rows_op_A, int cols_op_B, int cols_op_A_rows_op_B, const double alpha, const double *A,
...
)
{
    ...
    lapack_exters::dgemm_( &TRANSA, &TRANSB, &M, &N, &K, &ALPHA, (double *)A, &LDA, (double *)B, &LDB, &BETA, C, &LDC );
}
template <>
inline void lapack_wrap<float>::gemm(
    char opA, char opB, int rows_op_A, int cols_op_B, int cols_op_A_rows_op_B, const float alpha, const float *A,
...
)
{
    ...
    lapack_exters::sgemm_( &TRANSA, &TRANSB, &M, &N, &K, &ALPHA, (float *)A, &LDA, (float *)B, &LDB, &BETA, C, &LDC );
}
template <>
inline void lapack_wrap<double>::gemm(
    char opA, char opB, int rows_op_A, int cols_op_B, int cols_op_A_rows_op_B, const std::complex<double> alpha,
    const std::complex<double> *A, const std::complex<double> *B, const std::complex<double> beta,
...
)
{
    ...
    lapack_exters::zgemm_(
        &TRANSA, &TRANSB, &M, &N, &K, &ALPHA, (std::complex<double> *)A, &LDA, (std::complex<double> *)B, &LDB, &BETA,
        C, &LDC
    );
}
template <>
inline void lapack_wrap<float>::gemm(
    char opA, char opB, int rows_op_A, int cols_op_B, int cols_op_A_rows_op_B, const std::complex<float> alpha,
    const std::complex<float> *A, const std::complex<float> *B, const std::complex<float> beta, std::complex<float> *C
)
{
    ...
    lapack_exters::cgemm_(
        &TRANSA, &TRANSB, &M, &N, &K, &ALPHA, (std::complex<float> *)A, &LDA, (std::complex<float> *)B, &LDB, &BETA, C,
        &LDC
    );
}

template <>
inline void lapack_wrap<double>::eigs_schur(
    const double *A, size_t Nl, double *eigs_real, double *eigs_imag, double *Q, double *R
)
{
    ...
    lapack_exters::dgees_(
        &JOBVS, &SORT, &SELECT, &N, R, &N, &SDIM, eigs_real, eigs_imag, Q, &N, worker, &LWORK, &BWORK, &INFO
    );
...
template <>
inline void
lapack_wrap<float>::eigs_schur( const float *A, size_t Nl, float *eigs_real, float *eigs_imag, float *Q, float *R )
{
