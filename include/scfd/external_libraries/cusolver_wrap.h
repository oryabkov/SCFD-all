...
public:
    ...
    cusolver_wrap( blas_t *cublas_, bool do_set_inst = false )
    ...
    cusolver_wrap( bool plot_info, bool do_set_inst = false )
        : manual_init_singleton( this, do_set_inst ), handle_created( false )
    {
        if ( plot_info )
        {
...
template <>
inline void cusolver_wrap::geqrf_ormqr(
...
template <>
inline void cusolver_wrap::qr_size(
...
template <>
inline void cusolver_wrap::geqrf_size( size_t rows, size_t cols, const double *A, size_t lda )
{
...
template <>
inline void cusolver_wrap::geqrf_size( size_t rows, size_t cols, const float *A, size_t lda )
{
...
template <>
inline void
cusolver_wrap::orgqr_size( size_t rows, size_t cols, size_t k, const double *A, size_t lda, const double *tau )
{
...
template <>
inline void
cusolver_wrap::orgqr_size( size_t rows, size_t cols, size_t k, const float *A, size_t lda, const float *tau )
{
...
template <>
inline void cusolver_wrap::ormqr_size(
...
template <>
inline void cusolver_wrap::ormqr_perform(
    char operation_, char side_, size_t m, size_t n, size_t k, const double *A, size_t lda, const double *tau,
    double *C, size_t ldc
)
{
...
template <>
inline void cusolver_wrap::eig( size_t rows_cols, double *A, double *lambda )
{
...
template <>
inline void cusolver_wrap::eig( size_t rows_cols, float *A, float *lambda )
{
    cusolverEigMode_t jobz  = CUSOLVER_EIG_MODE_VECTOR; // compute eigenvalues and eigenvectors.
    cublasFillMode_t  uplo  = CUBLAS_FILL_MODE_LOWER;
    int               m     = rows_cols;
