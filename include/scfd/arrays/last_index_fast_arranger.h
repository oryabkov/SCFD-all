...
struct last_index_fast_arranger<Dim0, Dim1> : public arranger_base<ordinal_type, Dim0, Dim1>
{
    ...
    {
#ifdef SCFD_ARRAYS_ENABLE_INDEX_SHIFT
        return ( i0 - this->template get_index0<0>() ) * this->template get_dim<1>() + i1 -
               this->template get_index0<1>();
#else
        return ( i0 ) * this->template get_dim<1>() + i1;
#endif
    }
};
...
#else
        return ( ( i0 ) * this->template get_dim<1>() + i1 ) * this->template get_dim<2>() + i2;
#endif
    }
};
...
struct last_index_fast_arranger<Dim0, Dim1, Dim2, Dim3, Dim4>
...
struct last_index_fast_arranger<Dim0, Dim1, Dim2, Dim3, Dim4, Dim5>
    ...
    ) const
    {
        ...
        return ( ( ( ( ( i0 - this->template get_index0<0>() ) * this->template get_dim<1>() + i1 -
                   ...
                   i3 - this->template get_index0<3>() ) *
                     this->template get_dim<4>() +
                 i4 - this->template get_index0<4>() ) *
                   this->template get_dim<5>() +
               i5 - this->template get_index0<5>();
#else
        return ( ( ( ( ( i0 ) * this->template get_dim<1>() + i1 ) * this->template get_dim<2>() + i2 ) *
                       this->template get_dim<3>() +
                   i3 ) *
...
template <
    ordinal_type Dim0, ordinal_type Dim1, ordinal_type Dim2, ordinal_type Dim3, ordinal_type Dim4, ordinal_type Dim5,
    ordinal_type Dim6>
struct last_index_fast_arranger<Dim0, Dim1, Dim2, Dim3, Dim4, Dim5, Dim6>
    ...
    ) const
    {
        ...
        return ( ( ( ( ( ( i0 - this->template get_index0<0>() ) * this->template get_dim<1>() + i1 -
                   ...
                   i4 - this->template get_index0<4>() ) *
                     this->template get_dim<5>() +
                 i5 - this->template get_index0<5>() ) *
                   this->template get_dim<6>() +
               i6 - this->template get_index0<6>();
#else
        return ( ( ( ( ( ( i0 ) * this->template get_dim<1>() + i1 ) * this->template get_dim<2>() + i2 ) *
                         this->template get_dim<3>() +
                     i3 ) *
