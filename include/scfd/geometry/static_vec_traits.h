...
struct static_vec_traits
{
    ...
    /// v2  += v1 *mul1
    inline __DEVICE_TAG__ static void add_mul( scalar_type mul1, const Vec &v1, Vec &v2 );
    /// v2  = v1*mul1
    inline __DEVICE_TAG__ static void assign_mul( scalar_type mul1, const Vec &v1, Vec &v2 );
    /// v3  = v1+v2
    inline __DEVICE_TAG__ static void assign_sum( const Vec &v1, const Vec &v2, Vec &v3 );
    /// returns v1+v2
    ...
    static_assert( !std::is_same<Vec, Vec>::value, "static_vec_traits: not specialized" );
};
...
public:
    ...
    /// v2  += v1*mul1
    inline __DEVICE_TAG__ static void add_mul( scalar_type mul1, const vec_type &v1, vec_type &v2 )
    {
        v2 += v1 * mul1;
    }
    /// v2  = v1*mul1
    inline __DEVICE_TAG__ static void assign_mul( scalar_type mul1, const vec_type &v1, vec_type &v2 )
    {
        v2 = v1 * mul1;
    }
    /// v3  = v1+v2
    inline __DEVICE_TAG__ static void assign_sum( const vec_type &v1, const vec_type &v2, vec_type &v3 )
    {
        v3 = v1 + v2;
    }
    /// returns v1+v2
    ...
    inline __DEVICE_TAG__ static void assign_vector_prod( const vec_type &v1, const vec_type &v2, vec_type &v3 )
    {
