...
template <typename T>
__DEVICE_TAG__ bool
are_projections_separated( const T &p0, const T &p1, const T &p2, const T &q0, const T &q1, const T &q2 )
{
...
//main checker
template <typename T, class Vec>
__DEVICE_TAG__ bool intersect_triangles(
    const Vec &t0_v0, const Vec &t0_v1, const Vec &t0_v2, const Vec &t1_v0, const Vec &t1_v1, const Vec &t1_v2
)
{
    typedef static_vec_traits<Vec> vt;
