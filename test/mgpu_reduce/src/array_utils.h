...
Ord size_by_key( Ord rows_n, const Keys keys_in, Keys keys_out, Vals vals_out )
{
    ...
    auto new_end = thrust::reduce_by_key(
        scfd::arrays::array_thrust_begin( keys_in ), scfd::arrays::array_thrust_begin( keys_in ) + rows_n,
        ::thrust::make_counting_iterator<T>( 1 ), scfd::arrays::array_thrust_begin( keys_out ),
...
Ord reduce_by_key( Ord rows_n, const Keys keys_in, const Vals vals_in, Keys keys_out, Vals vals_out )
{
    ...
    auto new_end = thrust::reduce_by_key(
        scfd::arrays::array_thrust_begin( keys_in ), scfd::arrays::array_thrust_begin( keys_in ) + rows_n,
        scfd::arrays::array_thrust_begin( vals_in ), scfd::arrays::array_thrust_begin( keys_out ),
        scfd::arrays::array_thrust_begin( vals_out )
    );
...
Ord reduce_by_key_min( Ord rows_n, const Keys keys_in, const Vals vals_in, Keys keys_out, Vals vals_out )
{
    ...
    auto new_end = thrust::reduce_by_key(
        scfd::arrays::array_thrust_begin( keys_in ), scfd::arrays::array_thrust_begin( keys_in ) + rows_n,
        scfd::arrays::array_thrust_begin( vals_in ), scfd::arrays::array_thrust_begin( keys_out ),
        scfd::arrays::array_thrust_begin( vals_out ), thrust::equal_to<typename Keys::value_type>(),
...
{
    thrust::sort_by_key(
        scfd::arrays::array_thrust_begin( keys ), scfd::arrays::array_thrust_begin( keys ) + rows_n,
...
void sort( Ord rows_n, Vec vec1 )
{
    ...
    thrust::sort( scfd::arrays::array_thrust_begin( vec1 ), scfd::arrays::array_thrust_begin( vec1 ) + rows_n );
}
...
Ord unique( Ord rows_n, Vec vec1 )
{
    ...
    auto ret_device =
        thrust::unique( scfd::arrays::array_thrust_begin( vec1 ), scfd::arrays::array_thrust_begin( vec1 ) + rows_n );
...
Ord set_intersection( Set set1, Ord size_x0, Set set2, Ord size_xN, Set set_ret )
{
    ...
    auto ret_device = thrust::set_intersection(
        scfd::arrays::array_thrust_begin( set1 ), scfd::arrays::array_thrust_begin( set1 ) + size_x0,
        scfd::arrays::array_thrust_begin( set2 ), scfd::arrays::array_thrust_begin( set2 ) + size_xN,
...
T inclusive_scan_inplace( Ord rows_n, Vec ptr )
{
    thrust::inclusive_scan(
        scfd::arrays::array_thrust_begin( ptr ), scfd::arrays::array_thrust_begin( ptr ) + rows_n,
        scfd::arrays::array_thrust_begin( ptr )
    );

    T nnz_;
    thrust::copy(
        scfd::arrays::array_thrust_begin( ptr ) + rows_n - 1, scfd::arrays::array_thrust_begin( ptr ) + rows_n, &nnz_
    );
...
T exclusive_scan_inplace( Ord rows_n, Vec ptr )
{
    T last_val;
    thrust::copy(
        scfd::arrays::array_thrust_begin( ptr ) + rows_n - 1, scfd::arrays::array_thrust_begin( ptr ) + rows_n,
        &last_val
    );
    ...
    return nnz_ +
           last_val; //returned value is the sum of all aelement, since ptr[rows_n-1] is removed by exclusive_scan
}
...
{
    T res = thrust::reduce(
        scfd::arrays::array_thrust_begin( ptr ), scfd::arrays::array_thrust_begin( ptr ) + rows_n, T( 0 )
    );
