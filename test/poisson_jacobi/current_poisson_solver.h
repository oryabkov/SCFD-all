...
#    include <scfd/backend/reduce/omp_reduce.h>
...
#    include <scfd/backend/reduce/sycl_reduce.h>
...
template <>
struct sycl::is_device_copyable<typename poisson_solver_t::rhs_init_func_t> : std::true_type
{
};
template <>
struct sycl::is_device_copyable<typename poisson_solver_t::vanish_func_t> : std::true_type
{
};
template <>
struct sycl::is_device_copyable<typename poisson_solver_t::sqr_func_t> : std::true_type
{
};
template <>
struct sycl::is_device_copyable<typename poisson_solver_t::iter_func_t> : std::true_type
{
};
#endif
