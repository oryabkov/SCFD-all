...
{
    template <typename... Ts>
    __DEVICE_TAG__ static ordinal_type
    get( ordinal_type i0, ordinal_type i1, ordinal_type i2, ordinal_type i3, const Ts &...index_tail )
    {
        return i3;
    }
};
        ...
        __DEVICE_TAG__ ordinal_type calc_lin_index( ordinal_type i0, ordinal_type i1, ordinal_type i2 ) const
        {
            ...
            return detail::axis_size<First>::get( i0, i1, i2 ) - this->template get_index0<First>() +
                   this->template get_dim<First>() *
                       ( ( detail::axis_size<Second>::get( i0, i1, i2 ) - this->template get_index0<Second>() ) +
                         this->template get_dim<Second>() *
                             ( detail::axis_size<Third>::get( i0, i1, i2 ) - this->template get_index0<Third>() ) );

#else

            return detail::axis_size<First>::get( i0, i1, i2 ) +
                   this->template get_dim<First>() *
                       ( detail::axis_size<Second>::get( i0, i1, i2 ) +
    ...
    struct type : public arranger_base<ordinal_type, Dim0, Dim1, Dim2, Dim3>
    {
        ...
        calc_lin_index( ordinal_type i0, ordinal_type i1, ordinal_type i2, ordinal_type i3 ) const
        {
            ...
            return detail::axis_size<First>::get( i0, i1, i2, i3 ) +
                   this->template get_dim<First>() *
                       ( detail::axis_size<Second>::get( i0, i1, i2, i3 ) +
                         this->template get_dim<Second>() *
